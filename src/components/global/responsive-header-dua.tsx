...
const ResponsiveHeaderDua = ({ name }: ResponsiveHeaderProps) => {
  return (
    <div>
      {/* Desktop Header */}
      <header className="fixed hidden top-0 left-0 z-10 w-full items-center justify-between gap-4 border-b border-[#2F3B4B] bg-[#0E1319] p-4 lg:flex">
        <h1 className="text-xl hidden lg:block font-semibold text-white">
          {name}
        </h1>
...
export default ResponsiveHeaderDua;
